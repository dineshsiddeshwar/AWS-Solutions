            ...
            for region in self.regions:
                ...
                body_text = """
                    ...
                    Transitgateway integration is processed now. Below are the processed details and results.          
                        * Account Number : """ + self.event['ProvisionedProduct']['AccountNumber'] + """
                        * Account Name : """ + self.event['ProvisionedProduct']['Name'] + """
                        * Account Type : """ + self.event['tgw']['account_type'] + """
                        * Environment : """ + self.event['tgw']['environment'] + """
                        * Request Id : """ + self.event['RequestEventData']['RequestNo'] + """
                        * Region : """ + region + """
                ...
                body_html = """<html>
                    ...
                    <table style="width:100%">
                      ...
                      <tr>
                        ...
                        <td width="50%">""" + self.event['ProvisionedProduct']['AccountNumber'] + """</td>
                      </tr>
                      <tr>
                        <td width="50%">Account Name</td>
                        <td width="50%">""" + self.event['ProvisionedProduct']['Name'] + """</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td width="50%">""" + self.event['RequestEventData']['RequestNo'] + """</td>
                      </tr>
                      <tr>
                ...
                send_mail_response = self.ses_client.send_email(
                    ...
                    Message={
                        'Subject': {
                            'Data': self.event['RequestEventData']['RequestNo']+': VPC TGW Association Status'
                        },
                        'Body': {
                            'Text': {
                                'Data': body_text
