...
import random
import os
from TestCases.aws_emr_tests import *
...
def test_aws_check_if_emr_block_public_enabled(region):
    emr_client = assumeRoleSession.client('emr', region_name=region)
    assert aws_check_if_emr_block_public_enabled(emr_client) == True