...
def test_aws_check_if_s3_block_public_enabled():
    s3control_client = assumeRoleSession.client('s3control')
    assert aws_check_if_s3_block_public_enabled(s3control_client, parameters_data['ProvisionedProduct']['AccountNumber']) == True