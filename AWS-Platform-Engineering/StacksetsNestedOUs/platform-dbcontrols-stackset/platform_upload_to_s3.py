...
try:
      ...
      if os.path.isdir(workspacepath):
            print("Did find the path to upload the Step function JSON file..!!")
            for r,d,f in os.walk(workspacepath+"/StepFunctionFiles"):
                  print(r, d, f)
                  for i in f:  
                        layer_zip_path = os.path.join(r, i)                                         
                        upload_stackset_resources_to_s3(layer_zip_path,i)
            print("Step function JSON upload completed..!!")
      else:
            print("Did not find the base path for Step function JSON file upload..!!") 
