...
result = "fail" {
	not input.StorageResourceProviderBlobServiceProperties.Logging.Delete == true
}{
	not input.StorageResourceProviderBlobServiceProperties.Logging.Read == true
}{
	not input.StorageResourceProviderBlobServiceProperties.Logging.Write == true
}{
	not input.StorageResourceProviderQueueServiceProperties.Logging.Delete == true
}{
	not input.StorageResourceProviderQueueServiceProperties.Logging.Read == true
}{
	not input.StorageResourceProviderQueueServiceProperties.Logging.Write == true
}{
	not input.StorageResourceProviderTableServiceProperties.Logging.Delete == true
}{
	not input.StorageResourceProviderTableServiceProperties.Logging.Read == true
}{
	not input.StorageResourceProviderTableServiceProperties.Logging.Write == true
}
