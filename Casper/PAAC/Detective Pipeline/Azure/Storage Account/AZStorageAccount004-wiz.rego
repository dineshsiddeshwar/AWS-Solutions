...
currentConfiguration = "Public access is allowed on blobs in the storage account"
expectedConfiguration = "Public access should be disallowed on blobs in the storage account"
