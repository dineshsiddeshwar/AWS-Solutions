...
result = "pass" {
	input.AccountStorageServicesBlobServiceProperties.properties.deleteRetentionPolicy.enabled
}

expectedConfiguration = "deleteRetentionPolicy should be enabled to allow blob recovery."
currentConfiguration = "deleteRetentionPolicy is disabled."