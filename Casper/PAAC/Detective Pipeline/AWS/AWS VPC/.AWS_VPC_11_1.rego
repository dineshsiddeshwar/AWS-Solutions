...
result = "pass" {
    input.vpcRouteTables[0].Routes[0].VpcPeeringConnectionId == null
    input.vpcRouteTables[0].Routes[1].VpcPeeringConnectionId == null
    input.vpcRouteTables[1].Routes[0].VpcPeeringConnectionId == null
}