...
result = "pass" {
 input.CloudTrailStatus.IsLogging != true ;
 input.CloudTrailStatus.StopLoggingTime != null ;
 input.CloudTrailStatus.TimeLoggingStopped != ""
}

## if the 3 condition is not equals to true & null & "" . then, the 
## logic will detect  if Organization CloudTrail stopped or not.