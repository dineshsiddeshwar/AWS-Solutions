...
result = "pass" {
  input.accountPublicAccessBlockConfiguration.BlockPublicAcls ;
  input.accountPublicAccessBlockConfiguration.BlockPublicPolicy == true
}

## If S3 bucket has BlockPublicAcls & BlockPublicPolicy true, then, logic will pass, 
## hence detecting the public access is there or not to S3 bucket which is attached to CloudTrail.
